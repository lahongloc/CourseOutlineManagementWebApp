...
import { Autocomplete, TextField, Button, List, ListItem, ListItemText, Paper, ListItemAvatar, Avatar, Typography } from '@mui/material';
        ...
        <div className="App container">
            ...
            <div>
              <Autocomplete
                ...
                sx={{ width: "100%" }}
                renderInput={(params) => (
                  <TextField {...params} label="Chọn người muốn gửi tin nhắn" />
                )}
              />
            </div>
            {selectedReceiver && (
              <>
                <Paper style={{ maxHeight: 400, overflow: 'auto', marginTop: 20, marginBottom: 20 }}>
                  <List>
                    {messages.map((message, index) => (
                      <ListItem 
                        key={index} 
                        style={{ 
                          justifyContent: message.sender === user.email ? 'flex-end' : 'flex-start' 
                        }}
                      >
                        <ListItemAvatar>
                        ...
                        <ListItemText
                          ...
                          style={{ 
                            ...
                            backgroundColor: message.sender === user.email ? '#dcf8c6' : '#fff',
                            borderRadius: '10px',
                            padding: '10px',
                            maxWidth: '60%'
                          }}
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', alignItems: 'center', marginTop: 20 }}>
                  <TextField
                    type="text"
