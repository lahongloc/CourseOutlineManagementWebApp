<%-- Document : userDetails Created on : May 24, 2024, 3:13:26 PM Author : lahon
...
<div
	class="row d-flex justify-content-center align-items-center container-fluid"
>
	<!-- Phần 60% -->
						...
						<div class="row pt-1">
							<div class="col-6 mb-3">
								...
								<p class="text-muted">
									<c:choose>
										<c:when
											test="${user.role eq 'ROLE_ADMIN'}"
										>
											Quản trị viên
										</c:when>
										<c:when
											test="${user.role eq 'ROLE_LECTURER'}"
										>
											Giảng Viên
										</c:when>
