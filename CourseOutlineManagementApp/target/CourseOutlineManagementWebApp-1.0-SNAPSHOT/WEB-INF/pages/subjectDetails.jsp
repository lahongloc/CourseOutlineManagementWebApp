...
<div class="container">
    ...
    <form action="<c:url value="/outline-management/${param.subjectId}/" />" method="POST">
        <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="academicYear1" class="form-label">Academic Year 1</label>
            ...
            <div class="mb-3">
                <label for="academicYear2" class="form-label">Academic Year 2 (Optional, must be consecutive to Academic Year 1)</label>
