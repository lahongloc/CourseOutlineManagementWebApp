<%-- 
    Document   : introduce.jsp
    Created on : May 24, 2024, 12:24:13 PM
    Author     : lahon
--%>
    ...
    <div class="d-flex flex-column justify-content-around align-items-center">
        ...
        <div class="d-flex justify-content-between align-items-center p-5" >
            <div class="card pt-5" style="width:fit-content; border: none;">
                <img style="padding-bottom: 1px" height="45px"  src="https://minimals.cc/assets/icons/home/ic_make_brand.svg" alt="Card image">
                <div class="p-5">
            ...
            <div class="card pt-5" style="margin: 0 5.5rem 0; width:fit-content; border: none; border-radius: 16px;box-shadow: rgba(0, 0, 0, 0.25) 0px 25px 50px -12px;">
                <img style="padding-bottom: 1px" height="45px"  src="https://minimals.cc/assets/icons/home/ic_design.svg" alt="Card image">
                <div class="p-5">
            ...
            <div class="card pt-5" style="width:fit-content; border: none;">
                <img style="padding-bottom: 1px" height="45px"  src="https://minimals.cc/assets/icons/home/ic_development.svg" alt="Card image">
                <div class="p-5">
